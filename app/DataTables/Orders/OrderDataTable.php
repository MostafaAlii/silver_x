...
class OrderDataTable extends BaseDataTable {
    ...
    public function getColumns(): array {
        return [
            ...
            ['name' => 'client_name', 'data' => 'client_name', 'title' => 'User-name', 'orderable' => false, 'searchable' => false,],
            ['name' => 'captain_name', 'data' => 'captain_name', 'title' => 'Captain-name', 'orderable' => false, 'searchable' => false,],
