...
Route::group(
    ...
    Route::group(['prefix' => 'admin', 'middleware' => 'auth:admin'], function () {
        ...
        Route::get('captains/{captainId}/bounes', [Admin\CaptainController::class, 'bouns'])->name('captains.bouns');
        Route::post('captains/{bounsId}/update-bouns-status', [Admin\CaptainController::class, 'updateBounsStatus'])->name('captains.update-bouns-status');
